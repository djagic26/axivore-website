...
export function Marquee() {
  ...
  const sectionBg = isDark ? "linear-gradient(180deg, #070512 0%, #050410 100%)" : "#ffffff";
  const borderColor = isDark ? "rgba(160,154,255,0.12)" : "rgba(0,0,0,0.06)";
  ...
  const fadeColor = isDark ? "#050410" : "#ffffff";
