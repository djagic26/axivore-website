...
const CONTENT: Record<"de" | "hr" | "en" | "ro" | "tr" | "it", {
  ...
  de: {
    ...
    faq: [
      ...
      { question: "Was passiert, wenn sich mein Prozess später ändert?", answer: "Das System wächst mit. Ändert sich dein Ablauf, passen wir die Automatisierung entsprechend an — meldest du dich einfach, wir kümmern uns darum." },
    ],
  ...
  hr: {
    ...
    faq: [
      ...
      { question: "Što ako se moj proces kasnije promijeni?", answer: "Sustav raste s tobom. Ako se tvoj tijek rada promijeni, prilagodimo automatizaciju u skladu s tim — samo se javiš, mi se pobrinemo za ostalo." },
    ],
  ...
  en: {
    ...
    faq: [
      ...
      { question: "What happens if my process changes later?", answer: "The system grows with you. If your workflow changes, we adjust the automation accordingly — just reach out and we take care of it." },
    ],
  ...
  ro: {
    ...
    faq: [
      ...
      { question: "Ce se întâmplă dacă procesul meu se schimbă mai târziu?", answer: "Sistemul crește odată cu tine. Dacă fluxul tău de lucru se schimbă, ajustăm automatizarea corespunzător — ne scrii, iar noi ne ocupăm de rest." },
    ],
  ...
  tr: {
    ...
    faq: [
      ...
      { question: "Sürecim daha sonra değişirse ne olur?", answer: "Sistem seninle birlikte büyür. İş akışın değişirse otomasyonu buna göre uyarlarız — sen sadece bize ulaş, gerisini biz hallederiz." },
    ],
  ...
  it: {
    ...
    faq: [
      ...
      { question: "Cosa succede se il mio processo cambia in seguito?", answer: "Il sistema cresce con te. Se il tuo flusso di lavoro cambia, adattiamo l'automazione di conseguenza — ci scrivi e ci pensiamo noi." },
    ],
