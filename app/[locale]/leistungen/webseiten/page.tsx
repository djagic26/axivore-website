...
const CONTENT: Record<"de" | "hr" | "en" | "ro" | "tr" | "it", {
  ...
  de: {
    ...
    faq: [
      ...
      { question: "Ich habe schon eine Website — geht das trotzdem?", answer: "Ja. Beim Relaunch achten wir darauf, dass bestehende URLs korrekt weitergeleitet werden und keine Google-Platzierungen verloren gehen." },
    ],
  ...
  hr: {
    ...
    faq: [
      ...
      { question: "Već imam web stranicu — je li to ipak moguće?", answer: "Da. Kod relaunch-a pazimo da se postojeći URL-ovi ispravno preusmjere i da ne izgubiš pozicije na Googleu." },
    ],
  ...
  en: {
    ...
    faq: [
      ...
      { question: "I already have a website — is this still possible?", answer: "Yes. During a relaunch we make sure existing URLs redirect correctly and you don't lose your Google rankings." },
    ],
  ...
  ro: {
    ...
    faq: [
      ...
      { question: "Am deja un site web — se poate totuși?", answer: "Da. La relansare avem grijă ca URL-urile existente să fie redirecționate corect și să nu pierzi pozițiile din Google." },
    ],
  ...
  tr: {
    ...
    faq: [
      ...
      { question: "Zaten bir web sitem var — yine de mümkün mü?", answer: "Evet. Yeniden lansmanda mevcut URL'lerin doğru şekilde yönlendirilmesine ve Google sıralamalarını kaybetmemene dikkat ederiz." },
    ],
  ...
  it: {
    ...
    faq: [
      ...
      { question: "Ho già un sito web — è comunque possibile?", answer: "Sì. Durante il relaunch facciamo attenzione che gli URL esistenti vengano reindirizzati correttamente e che tu non perda le posizioni su Google." },
    ],
