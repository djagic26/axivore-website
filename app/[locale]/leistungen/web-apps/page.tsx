...
const CONTENT: Record<"de" | "hr" | "en" | "ro" | "tr" | "it", {
  ...
  de: {
    ...
    faq: [
      ...
      { question: "Was passiert nach dem Launch — gibt es Support?", answer: "Ja. Wir verschwinden nicht nach dem Go-Live. Auf Wunsch übernehmen wir laufende Wartung, Weiterentwicklung und Support — planbar und ohne Überraschungen." },
    ],
  ...
  hr: {
    ...
    faq: [
      ...
      { question: "Što se događa nakon lansiranja — postoji li podrška?", answer: "Da. Ne nestajemo nakon go-livea. Po želji preuzimamo tekuće održavanje, daljnji razvoj i podršku — planibilno i bez iznenađenja." },
    ],
  ...
  en: {
    ...
    faq: [
      ...
      { question: "What happens after launch — is there support?", answer: "Yes. We don't disappear after go-live. On request we take care of ongoing maintenance, further development and support — plannable, with no surprises." },
    ],
  ...
  ro: {
    ...
    faq: [
      ...
      { question: "Ce se întâmplă după lansare — există suport?", answer: "Da. Nu dispărem după go-live. La cerere preluăm mentenanța continuă, dezvoltarea ulterioară și suportul — planificabil, fără surprize." },
    ],
  ...
  tr: {
    ...
    faq: [
      ...
      { question: "Lansmandan sonra ne olur — destek var mı?", answer: "Evet. Yayına almadan sonra ortadan kaybolmayız. İstek üzerine sürekli bakım, geliştirme ve desteği üstleniriz — planlanabilir ve sürprizsiz." },
    ],
  ...
  it: {
    ...
    faq: [
      ...
      { question: "Cosa succede dopo il lancio — c'è supporto?", answer: "Sì. Non spariamo dopo il go-live. Su richiesta ci occupiamo di manutenzione continua, sviluppo futuro e supporto — pianificabile e senza sorprese." },
    ],
