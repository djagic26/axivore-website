...
// Deep SEO content translated one market at a time — currently German, Croatian, English, Romanian, Turkish and Italian.
const PARTIAL_LOCALES: readonly AppLocale[] = ["de", "hr", "en", "ro", "tr", "it"];
